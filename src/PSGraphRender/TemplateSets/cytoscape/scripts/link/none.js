    ...
    //
    // This file therefore defines nothing. The node-action and selection-action
    // slots are empty for this mode, so nothing calls what is not here, and
    // absolutePathFor in link/common.js still serves Copy Path - which is a
    // fact about the payload rather than a link to anywhere.
