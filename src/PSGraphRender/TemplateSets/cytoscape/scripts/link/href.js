    ...
    var LINK_TOKENS = {
        ...
        '{path}': function (node) { return encodeURIComponent(node.data('path') || ''); },
        '{id}': function (node) { return encodeURIComponent(node.data('id') || ''); },
        '{label}': function (node) { return encodeURIComponent(node.data('name') || ''); },
        '{line}': function (node) { return encodeURIComponent(node.data('startLine') || 1); }
    };
    ...
    // result is assigned to an anchor's href PROPERTY in menu.js, never
